    ...
    public ConnectionKeepAliveStrategy connectionKeepAliveStrategy(){
        return (response, context) -> {
            ...
            while (it.hasNext()) {
                ...
                try {
                    log.info("HeaderElement:{}", new ObjectMapper().writeValueAsString(he));
            ...
            Optional<Map.Entry<String, Integer>> any = Optional.ofNullable(httpClientPoolConfig.getKeepAliveTargetHost())
